...
const addButtonComponents = (
  ...
  const buttonConfig = {
    '.btn': {
      ...
      "&[variant='primary']": {
        ...baseButtonStyles,
        border: '1px solid theme(colors.p-background)',
        backgroundColor: 'transparent',
        color: 'theme(colors.p-background)',

        '&:hover, &:active': {
          backgroundColor: 'theme(colors.p-background)',
          borderColor: 'theme(colors.p-background)',
...
const handler = (
  ...
  const typographyBase = TypeSchema.safeParse(manifest[ManifestKeys.Typography])
